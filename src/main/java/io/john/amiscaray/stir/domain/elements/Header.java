...
public class Header extends AbstractElementContainer<AbstractUIElement>{
    ...
    public Header(String id, List<String> cssClasses, String style, List<AbstractUIElement> children, boolean hidden, Map<String, String> customAttributes) {
    ...
    public static class HeaderBuilder {
        ...
        public HeaderBuilder customAttribute(String customAttributeKey, String customAttributeValue) {
        ...
        public HeaderBuilder customAttributes(Map<? extends String, ? extends String> customAttributes) {
            if (this.customAttributes$key == null) {
                this.customAttributes$key = new ArrayList<String>();
                this.customAttributes$value = new ArrayList<String>();
            }
        ...
        public HeaderBuilder clearCustomAttributes() {
            if (this.customAttributes$key != null) {
        ...
        public Header build() {
            ...
            return new Header(id, cssClasses, style, children, hidden, customAttributes);
        }

        public String toString() {
            return "Header.HeaderBuilder(id=" + this.id + ", cssClasses=" + this.cssClasses + ", style=" + this.style + ", children=" + this.children + ", hidden=" + this.hidden + ", customAttributes$key=" + this.customAttributes$key + ", customAttributes$value=" + this.customAttributes$value + ")";
        }
    }
}
